# -*- coding: utf-8 -*-
"""
Created on Thu Apr  2 14:06:40 2020
...
val1 = (today - datetime.datetime(2019,3,31,12,0,0,0)).total_seconds()
val2 = (today - datetime.datetime(2020,3,12,12,0,0)).total_seconds()
val3 = (today - datetime.datetime(2020,4,1,17,0,0)).total_seconds()
val4 = (today - datetime.datetime(2020,4,30,12,0,0)).total_seconds()
